...
main_consola.py
-------
ESTE PUNTO DE ENTRADA LO DEJO PARA PROBAR SI PUEDO JUGAR AL MISMO JUEGO DESDE LA CONSOLA O DESDE EL APARTADO GRAFICO,
DESCARTAR EN CUALQUIER PUNTO Y USAR MAIN.PY PARA JUGAR AL PRINCIPAL.

Punto de entrada del juego Museum Card Collector.
Ejecutar con: python main_consola.py  --> Esto lo cambié para poder ejecutarlo tambien desde la consola si quiséramos
